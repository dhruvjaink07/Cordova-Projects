...
function set_pg_content(pg_id) {
  ...
  switch (pg_id) {
    case 1:
      content =
        '<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="background"><img src="slide1/1.png" width="1024" height="768"/></div>  <div class="title1"><img src="slide1/2.png"/></div>  <div class="title2"><img src="slide1/3.png"/></div>  <div class="title3"><img src="slide1/4.png"/></div>  <div class="title4"><img src="slide1/5.png"/></div>  <div class="title5"><img src="slide1/6.png"/></div>';
      break;
    case 2:
      content =
        '<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/1.png" width="1024" height="768"></div>  <div class="title1"><img src="slide2/2.png"/></div>  <div class="title2"><img src="slide2/3.png"/></div>  <div class="title3"><img src="slide2/4.png"/></div>  <div class="title4"><img src="slide2/5.png"/></div>  <div class="title5"><img src="slide2/6.png"/></div>  <div class="title6"><img src="slide2/7.png"/></div>  <div class="title7"><img src="slide2/8.png"/></div>';
      break;
    case 3:
      content =
        '<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="background"><img src="slide3/1.png" width="1024" height="768"></div>  <div class="title1"><img src="slide3/2.png"/></div>  <div class="title2"><img src="slide3/3.png"/></div>  <div class="title3"><img src="slide3/4.png"/></div>  <div class="title4"  class="frameopen"><img src="slide3/5.png"/></div>  <div class="title5"><img src="slide3/6.png"/></div>  <div class="title6"><img src="slide3/7.png"/></div>  <div class="title7"><img src="slide3/8.png"/></div>  <div class="title8"><img src="slide3/9.png"/></div>  <div class="title9"><img src="slide3/10.png"/></div>  <div class="title10"><img src="slide3/11.png"/></div>  <div class="title11"><img src="slide3/12.png"/></div>';
      break;
      }
...
function pack1click() {
  console.log("pack1click function called");
  setTimeout(() => {
    console.log("pack1");
    ...
    console.log("Opacity of .title5 set to 1");
  }, 100);
}


function pack1click1() {
  console.log("pack1click function called");
  setTimeout(() => {
    console.log("pack1");
